...
for seed in seeds:
    ...
    torch.save(poison_x,'poison_x_arxiv_GTA.pt')
    torch.save(poison_edge_index,'poison_edge_index_arxiv_GTA.pt')
    torch.save(poison_edge_weights,'poison_edge_weights_arxiv_GTA.pt')
    torch.save(poison_labels,'poison_labels_arxiv_GTA.pt')
