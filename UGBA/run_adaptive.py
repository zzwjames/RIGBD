...
torch.save(poison_x,'poison_x_cora_GTA.pt')
torch.save(poison_edge_index,'poison_edge_index_cora_GTA.pt')
torch.save(poison_edge_weights,'poison_edge_weights_cora_GTA.pt')
torch.save(poison_labels,'poison_labels_cora_GTA.pt')
...
for test_model in models:
    ...
    print('std of ASR',np.std(a))
    print('std of clean accuracy',np.std(b))
